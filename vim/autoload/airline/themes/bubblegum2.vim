...
" Normal mode
" let s:N1 = [s:gui_dark_gray, s:gui_purple, s:cterm_dark_gray, s:cterm_purple]
" let s:N2 = [s:gui_light_gray, s:gui_med_gray_lo, s:cterm_light_gray, s:cterm_med_gray_lo]
" let s:N3 = [s:gui_purple, s:gui_med_gray_hi, s:cterm_purple, s:cterm_med_gray_hi]
let s:N1 = [s:gui_dark_gray, s:gui_orange, s:cterm_dark_gray, s:cterm_purple]
let s:N2 = [s:gui_light_gray, s:gui_med_gray_lo, s:cterm_light_gray, s:cterm_med_gray_lo]
let s:N3 = [s:gui_orange, s:gui_med_gray_hi, s:cterm_orange, s:cterm_med_gray_hi]
...
" Insert mode
let s:I1 = [s:gui_med_gray_hi, s:gui_green, s:cterm_med_gray_hi, s:cterm_green]
let s:I3 = [s:gui_green, s:gui_med_gray_hi, s:cterm_green, s:cterm_med_gray_hi]
let g:airline#themes#bubblegum2#palette.insert = airline#themes#generate_color_map(s:I1, s:N2, s:I3)
...
" Visual mode
let s:V1 = [s:gui_dark_gray, s:gui_orange, s:cterm_dark_gray, s:cterm_light_gray]
let s:V3 = [s:gui_orange, s:gui_med_gray_hi, s:cterm_light_gray, s:cterm_med_gray_hi]
let g:airline#themes#bubblegum2#palette.visual = airline#themes#generate_color_map(s:V1, s:N2, s:V3)
...
let g:airline#themes#bubblegum2#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(
